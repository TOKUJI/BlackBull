...
| `BB_CLIENT_MIN_BODY_RATE` | no rate floor; a peer trickling one DATA frame per deadline satisfies `BB_CLIENT_BODY_TIMEOUT` indefinitely.  (That gap is tracked: `BLA-326` [private].) |
