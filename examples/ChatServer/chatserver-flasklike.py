"""
Chat Server (Flask-like style)
==============================
Same functionality as chatserver.py, but uses the BlackBull class directly
...
async def handle_chat_page(scope, receive, send):  # noqa: ARG001
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='BlackBull Chat Server (Flask-like)')
